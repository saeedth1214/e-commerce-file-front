        ...
        <v-row dense>
          ...
          >
            <v-btn
              ...
              height="30"
            >
              <v-avatar v-if="item.user.data.media" width="30" height="30">
                <img :src="item.user.data.media" />
              </v-avatar>
              <v-avatar v-else height="30" width="30">
                <v-icon dark style="font-size: 20px;">mdi-account-circle</v-icon>
              </v-avatar>
            </v-btn>
          </v-col>
          <v-col cols="12" sm="9" md="9" lg="9" style="margin-top: 1rem">
            <p class="text-subtitle-2 mr-2 font-weight-medium">
